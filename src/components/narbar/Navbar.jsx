...
function Navbar(props) {
  ...
  return (
    ...
    <div className='navigation-Wrapper'>
        ...
        <div  className='made'><span className='dave' title='Reach Us'> <i class="fa-solid fa-phone"></i> Tel:</span  > 07069672422 &nbsp; &nbsp; &nbsp; &nbsp; <a style={{color: 'white', textDecoration:'none'}} href="http://localhost:5173/cartlist"><i id='cart' class="fa-solid fa-cart-shopping"></i> {props.list}</a> </div>
    </div>
  )
}
